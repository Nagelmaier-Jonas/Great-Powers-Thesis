!function (t, e) {
    ...
    function D(t) {
        var e = t.parentNode, n = window.getComputedStyle(t), o = window.getComputedStyle(e),
            r = t.getBoundingClientRect(), a = e.getBoundingClientRect();
        return {
            elem: {
                style: n,
                width: r.width,
    ...
    var G = {
        ...
        setTransform: function (t, e, n) {
            var o = e.x, r = e.y, a = e.scale, e = e.isSVG;
    ...
    function t(d, f) {
        ...
        var t;
        f = C(C({}, G), f);
        var e, c = (e = d, F.test(e.namespaceURI) && "svg" !== e.nodeName.toLowerCase()), n = d.parentNode;
        ...
        var o, r, a, i, l, s, m = 0, h = 0, v = 1, p = !1;
        ...
        function w(t, e, n, o) {
            var r, a, i, l, c, s, p = C(C({}, f), o), u = {x: m, y: h, opts: p};
        ...
        function b(t, e) {
            var n = C(C({}, f), e), e = {scale: v, opts: n};
        ...
        S(f.startScale, {animate: !1}), setTimeout(function () {
        ...
        function P(t) {
            !function (t, e) {
                for (var n, o, r = t; null != r; r = r.parentNode) if (n = r, o = e.excludeClass, 1 === n.nodeType && -1 < (" " + (n.getAttribute("class") || "").trim() + " ").indexOf(" " + o + " ") || -1 < e.exclude.indexOf(r)) return 1
        ...
        function A(t) {
            var e;
            p && void 0 !== o && void 0 !== r && void 0 !== a && void 0 !== i && (N(M, t), e = L(M), 1 < M.length ? (0 === s && (s = I(M)), O(b((I(M) - s) * f.step / 80 + l).scale, e)) : x(o + (e.clientX - a) / v, r + (e.clientY - i) / v, {animate: !1}, t))
        }

        function z(t) {
            1 === M.length && u("panzoomend", {x: m, y: h, scale: v, isSVG: c, originalEvent: t}, f), function (t, e) {
        ...
        function Y() {
            X || (X = !0, W("down", f.canvas ? n : d, P), W("move", document, A, {passive: !0}), W("up", document, z, {passive: !0}))
        }

        return f.noBind || Y(), {
            bind: Y, destroy: function () {
                X = !1, Z("down", f.canvas ? n : d, P), Z("move", document, A), Z("up", document, z)
            }, eventNames: V, getPan: function () {
                return {x: m, y: h}
            }, getScale: function () {
                return v
            }, getOptions: function () {
                ...
                return B(d, t, e)
            }, zoom: S, zoomIn: function (t) {
                return E(!0, t)
            }, zoomOut: function (t) {
                return E(!1, t)
            }, zoomToPoint: O, zoomWithWheel: function (t, e) {
                t.preventDefault();
                var n = C(C({}, f), e), e = 0 === t.deltaY && t.deltaX ? t.deltaX : t.deltaY;
